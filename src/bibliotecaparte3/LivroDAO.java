...
public class LivroDAO implements DAO<Livro> {
    ...
    public void salvar(Livro livro) throws IOException {
        ...
        writer.write(livro.getId() + "," + livro.getTitulo() + "," + livro.getAutores() + "," + livro.getEditora() + "," + livro.getArea()
                + "," + livro.getAno() + "," + livro.getNumFolhas() + "," + livro.getEdicao() + "," + livro.isEmprestimo());
        writer.newLine();
        writer.close();
    }
    ...
    public Livro ler(int id) throws IOException {
        ...
        while ((currentLine = reader.readLine()) != null) {
            ...
            if (data.length < 9) {
                System.out.println("Linha do arquivo 'livros.txt' não contém todos os campos esperados: " + currentLine);
                continue;
            }
