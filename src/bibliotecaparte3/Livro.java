...
public class Livro extends Obra implements DAO<Livro> {
    ...
    private int edicao, numFolhas, id;
    ...
    public void salvar(Livro livro) throws IOException {
        ...
        writer.write(livro.getId() + "," + livro.getTitulo() + "," + livro.getAutores() + "," + livro.getArea() + "," + livro.getEditora() + "," + livro.getAno() + "," + livro.getEdicao() + "," + livro.getNumFolhas() + "," + livro.isEmprestimo());
        writer.newLine();
        writer.close();
    }
